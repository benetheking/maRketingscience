...
#' @param modell Input data. Just name the model you want to have the R² calculated for. Defaults to maRketingscience's "model1".
#' @keywords display R² of your MMM model
#' @export
#' @examples r_squared(modell)
#' r_squared()


r_squared <- function(modell = model1) {
